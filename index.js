��� 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢 𝗤𝗨𝗘 𝗣𝗢𝗦𝗦𝗔𝗠 𝗨𝗦𝗔𝗥 𝗘𝗦𝗧𝗘 𝗖𝗢𝗠𝗔𝗡𝗗𝗢🚫!*',
					Badmin: '*❌𝗔𝗣𝗘𝗡𝗔𝗦 𝗦𝗘 𝗢 𝗕𝗢𝗧 𝗙𝗢𝗥 𝗔𝗗𝗠 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢. 𝗦𝗘𝗠 𝗔𝗗𝗠 𝗡 𝗧𝗘𝗠 𝗖𝗢𝗠𝗢 𝗥𝗘𝗠𝗢𝗩𝗘𝗥 𝗡𝗚𝗠 𝗦𝗘𝗨 𝗕𝗘𝗦𝗧𝗔❌!*'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["556392942637@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["556392942637@s.whatsapp.net"] // GANTI NOMOR LU
			const frendsowner = ["5512997277680@s.whatsapp.net"] // GAUSAH DIGANTI!!!
			...
			switch(command) {
				...
				case 'info':
					...
					teks = `♫︎𝗡𝗢𝗠𝗘 𝗗𝗢 𝗕𝗢𝗧♫︎ : _${me.name}_\n 𝗡𝗨𝗠𝗘𝗥𝗢 𝗗𝗢 𝗕𝗢𝗧 : _@${me.jid.split('@')[0]}_\n 𝗣𝗥𝗘𝗙𝗜𝗫𝗢 𝗗𝗢 𝗕𝗢𝗧 : _${prefix}_\n 𝗧𝗢𝗧𝗔𝗟 𝗗𝗘 𝗕𝗟𝗢𝗖𝗞 : _${blocked.length}_\n 𝗦𝗢𝗨 𝗟𝗜𝗡𝗗𝗢 : _${kyun(uptime)}_\n 𝗦𝗢𝗨 𝗚𝗢𝗦𝗧𝗢𝗦𝗢* : 
					buffer = await getBuffer(me.imgUrl)
					client.sendMessage(from, buffer, image, {caption: teks, contextInfo:{mentionedJid: [me.jid]}})
					break
				case 'blocklist':
					teks = '𝗟𝗜𝗦𝗧𝗔 𝗗𝗘 𝗡𝗨𝗠𝗘𝗥𝗢𝗦 𝗕𝗟𝗢𝗖𝗞𝗘𝗔𝗗𝗢𝗦:\n'
				...
				case 'sticker':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`❌𝗙𝗔𝗟𝗛𝗔 𝗔𝗢 𝗙𝗔𝗭𝗘𝗥 𝗔𝗗𝗘𝗦𝗜𝗩𝗢 𝗦𝗧𝗜𝗖𝗞𝗘𝗥 𝗗𝗢 𝗩𝗜𝗗𝗘𝗢❌${tipe} ke stiker`)
							})
							.on('end', function () {
								console.log('Finish')
								buff = fs.readFileSync(ran)
					...
					/*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						...
						reply(`𝗘𝗡𝗩𝗜𝗘 𝗙𝗢𝗧𝗢 𝗖𝗢𝗠 𝗔 𝗟𝗘𝗚𝗘𝗡𝗗𝗔 𝗦𝗧𝗜𝗖𝗞𝗘𝗥 / 𝗔𝗗𝗘𝗦𝗜𝗩𝗢𝗦 𝗢𝗨 𝗧𝗔𝗚𝗦 𝗗𝗘 𝗜𝗠𝗔𝗚𝗘𝗠 𝗤𝗨𝗘 𝗙𝗢𝗥𝗔𝗠 𝗘𝗡𝗩𝗜𝗔𝗗𝗔𝗦 ${prefix}𝗘𝗡𝗩𝗜𝗘 𝗩𝗜𝗗𝗘𝗢 𝗚𝗜𝗙 𝗢𝗨 𝗙𝗢𝗧𝗢 𝗖𝗢𝗠 𝗔 𝗟𝗘𝗚𝗘𝗡𝗗𝗔`)
					}
					break
			case 'owner':
				...
				if (!isGroup) return reply(mess.only.group)
					...
					teks += `*𝗡𝗢𝗠𝗘 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢 :* ${groupName}\n*𝗗𝗘𝗦𝗖 :* ${groupDesc}\n*𝗧𝗢𝗧𝗔𝗟 𝗗𝗘 𝗔𝗗𝗠𝗦 :* ${groupAdmins.length}\n*𝗡𝗨𝗠𝗘𝗥𝗢𝗦 𝗗𝗘 𝗧𝗢𝗗𝗢𝗦 𝗠𝗘𝗠𝗕𝗥𝗢𝗦 :* ${groupMembers.length}`
					no = 0
		        ...
		        client.sendMessage(from, buffer, image, {quoted: mek, caption: `*𝗡𝗢𝗠𝗘* : ${groupName}\n*MEMBER* : ${groupMembers.length}\n*A𝗔𝗗𝗠𝗜𝗡* : ${groupAdmins.length}\n*𝗗𝗘𝗦𝗞* : ${groupDesc}`})
                break
				case 'testime':
					setTimeout( () => {
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6282347594640@s.whatsapp.net', options, text, {quoted: mek})
				...
				case 'memeindo':
					...
					break
				case 'ssweb':
					if (args.length < 1) return reply('Url em falta om')
					teks = body.slice(7)
					reply(mess.wait)
					...
					break
				case 'walpaperhd':
					if (args.length < 1) return reply('falta o texto om')
					teks = body.slice(7)
					reply(mess.wait)
				...
				case 'wibu':
					...
					wibu = ` 𝗡𝗢𝗠𝗘 ${anu.result.nama} 𝗗𝗘𝗦𝗞 ${anu.result.deskripsi}`
				...
				case 'chord':
					...
					break
				case 'ramalhp':
					if (args.length < 1) return reply('onde está o texto om?')
					kj = body.slice(12)
				...
				case 'textscreen':
					...
					break
			    case 'joox':
				if (args.length < 1) return reply(' Qual é o nome da música mana??')
               ...
               case 'infogempa':
                ...
                case 'tebakgambar':
					...
					setTimeout( () => {
					client.sendMessage(from, '*𝗡 𝗦𝗘𝗜 𝗞𝗞 :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
				...
				//animefoto
				case 'naruto':
					if (!isAnime) return reply('❌ 𝗩𝗖 𝗡 𝗔𝗧𝗜𝗩𝗢𝗨 𝗢 𝗠𝗢𝗗𝗢 𝗔𝗡𝗜𝗠𝗘 ❌')
                ...
                case 'indohot':
                   ...
                   break
				case 'ytmp4':
					if (args.length < 1) return reply('𝗢𝗡𝗗𝗘 𝗘𝗦𝗧𝗔 𝗢 𝗟𝗜𝗡𝗞 ?')
					if(!isUrl(args[0]) && !args[0].includes('youtu')) return reply(mess.error.Iv)
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 𝗔𝗗𝗠 𝗖𝗛𝗔𝗠𝗔𝗡𝗗𝗢 𝗧𝗢𝗗𝗢𝗦 〙✪══'+teks+'╚═〘 𝗡 𝗩𝗘𝗝𝗔 𝗣𝗢𝗥𝗡𝗢! 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `ıllıllı *𝗧𝗿𝗮𝗻𝘀𝗺𝗶𝘀𝘀𝗮𝗼 𝗔𝗼 𝗩𝗶𝘃𝗼* ıllıllı\n\n${body.slice(4)}`)
						}
						reply('𝗦𝗨𝗖𝗘𝗦𝗦𝗢')
					}
					break
			    ...
			    case 'kick':
					...
					if (mentioned.length > 1) {
						teks = '*「𝗦𝗨𝗖𝗘𝗦𝗦𝗢 , 𝗦𝗔𝗜 𝗙𝗢𝗥𝗔 𝗦𝗨𝗔 𝗣𝗨𝗧𝗔」* :\n'
						...
						mentions(`𝗦𝗨𝗖𝗘𝗦𝗦𝗢, 𝗕𝗔𝗡𝗜𝗗𝗢 𝗘𝗦𝗦𝗘 𝗠𝗘𝗥𝗗𝗔, 𝗦𝗔𝗜 𝗗𝗔𝗤𝗨𝗜 : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'edotense':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝗕𝗨𝗥𝗥𝗢. 𝗣𝗥𝗘𝗖𝗜𝗦𝗔 𝗠𝗔𝗥𝗖𝗔𝗥 𝗢 𝗠𝗘𝗠𝗕𝗥𝗢 𝗤𝗨𝗘 𝗗𝗘𝗦𝗘𝗝𝗔 𝗥𝗘𝗠𝗢𝗩𝗘𝗥 @!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
				...
				case 'promote':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '*「𝗔𝗚𝗢𝗥𝗔 𝗘𝗟𝗘 𝗩𝗜𝗥𝗢𝗨 𝗔𝗗𝗠𝗜𝗡. 𝗥𝗘𝗦𝗣𝗘𝗜𝗧𝗘 𝗘𝗟𝗘.」* :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
			    ...
			    case 'demote':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '*「𝗣𝗘𝗥𝗗𝗘𝗨 𝗔𝗗𝗠, 𝗜𝗦𝗦𝗢 𝗤𝗨𝗘 𝗗𝗔 𝗡 𝗙𝗔𝗭𝗘𝗥 𝗢 𝗧𝗥𝗔𝗕𝗔𝗟𝗛𝗢 𝗖𝗘𝗥𝗧𝗢!!😪」* :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
				...
				case 'listadmins':
					if (!isGroup) return reply(mess.only.group)
					teks = `𝗟𝗜𝗦𝗧𝗔 𝗗𝗢𝗦 𝗔𝗗𝗠𝗦 *${groupMetadata.subject}*\nTotal : ${groupAdmins.length}\n\n`
					no = 0
					for (let admon of groupAdmins) {
						no += 1
					...
					break
				case 'toimg':
					if (!isQuotedSticker) return reply('*「Marque a figurinha pra virar foto」*')
					reply(mess.wait)
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('*「𝗘𝗥𝗥𝗢, 𝗔𝗢 𝗖𝗢𝗡𝗩𝗘𝗥𝗧𝗘𝗥 𝗦𝗧𝗜𝗖𝗞𝗘𝗥 𝗘𝗠 𝗜𝗠𝗔𝗚𝗘𝗠」*')
		        ...
		        case 'setpp2':
                    if (!isGroup) return reply(mess.only.group)
                    if (!isadminbot) return reply('Quem é Voce?')
                    if (!isBotGroupAdmins) return reply(mess.only.Badmin)
                    media = await client.downloadAndSaveMediaMessage(mek)
                    await client.updateProfilePicture (from, media)
